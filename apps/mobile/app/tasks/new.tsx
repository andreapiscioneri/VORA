...
import { TASK_PRIORITIES } from '@vora/shared/types/task'
import type { ThemeColors } from '../../constants/theme'
import type { TaskInput, TaskPriority } from '@vora/shared/types/task'
...
export default function NewTaskScreen() {
  ...
  async function submit() {
    ...
    setSaving(true)
    try {
      await create(result.data as TaskInput)
      haptics.success()
      router.back()
    } catch {
      haptics.error()
  ...
  return (
    <DetailScreen title={t('tasks.form.newTitle')}>
