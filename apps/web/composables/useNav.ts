...
export const navGroups: { title: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'attendance', label: 'nav.attendance', icon: 'clock', to: '/attendance' },
      ...
      { key: 'orgChart', label: 'nav.orgChart', icon: 'users', to: '/org-chart' },
      { key: 'recruiting', label: 'nav.recruiting', icon: 'user-plus', to: '/recruiting' },
      { key: 'performanceReviews', label: 'nav.performanceReviews', icon: 'trending-up', to: '/performance-reviews' },
      { key: 'training', label: 'nav.training', icon: 'book-open', to: '/training' },
      { key: 'welfare', label: 'nav.welfare', icon: 'heart', to: '/welfare' },
      { key: 'payroll', label: 'nav.payroll', icon: 'credit-card', to: '/payroll' },
